...
{
    public partial class M_M_INQUERY_WRITE : PageBase
    {
        ...
        private void user_contact_add()
        {
            ...
            try
            {
                ...
                hs.Add("I_REQUEST_PROGRAM_ID", "M_M_INQUERY_WRITE");
                ...
                if (cp_ret_status == "N")
                {
                    ...
                    Response.Redirect("/Source/m/my/M_M_INQUERY_WRITE_DETAIL.aspx?bsid=" + BOARD_SID);
                }
            }
            catch (Exception ex)
            {
        ...
        private void user_contact_update()
        {
            ...
            try
            {
                ...
                if (cp_ret_status == "N")
                {
                    Response.Redirect("/Source/m/my/M_M_INQUERY_WRITE_DETAIL.aspx?bsid=" + I_BOARD_SID);
                }
            }
            catch (Exception ex)
            {
