                            ...
                            <div class="orderer_wrap_inner">
                                ...
                                <div class="deli_info">
                                    <div class="deli_info_first deli_info_flex_box">
                                        <div class="deli_info_main_txt deli_info_main_txt_font">
                                            <span class="star">*</span>
                                            <span class="main_title">배송지 확인</span>
                                        </div>
                                        <div class="block-example">
                                            <%--<div class="middle-font underline_block_example">radio</div>--%>
                                            <label class="drkid-radio">
                                                <input type="radio" name="radio" value="" checked="checked" id="place1" />
                                                <span class="lower-font">기본 배송지</span>
                                            </label>
                                            <label class="drkid-radio">
                                                <input type="radio" name="radio" value="" id="place2" />
                                                <span class="lower-font">최근 배송지</span>
                                            </label>
                                            <label class="drkid-radio">
                                                <input type="radio" name="radio" value="" id="place3" />
                                                <span class="lower-font">직접 입력</span>
                                            </label>
                                            <label class="drkid-radio">
                                                <input type="radio" name="radio" value="" id="place4" />
                                                <span class="lower-font">주문자정보와 동일</span>
                                            </label>
                                        </div>
                                        <div class="button new_Delivery_Btn">
                                            <span>배송지 관리</span>
                                        </div>
                                    </div>
                                    <div class="deli_info_first deli_info_flex_box">
                                        ...
                                        <div class="deli_info_sub_txt deli_info_main_sub_font mono_sub_color">
                                            <input type="text" name="name" data-placeholder="010-1234-5678" id="place_input1" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="give">
                                        ...
                                        <div class="second">
                                            <div class="second_top">
                                                <div class="input_box">
                                                    <input type="text" data-placeholder="48059" id="place_input2" />
                                                </div>
                                            ...
                                            <div class="second_bottom">
                                                <div class="input_box">
                                                    <input type="text" data-placeholder="부산광역시 해운대구 센텀동로99 (벽산이센텀클래스원)" id="place_input3" />
                                                </div>
                                                <div class="long_input_box">
                                                    <input type="text" data-placeholder="618-1호" id="place_input4" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="deli_info_first deli_info_flex_box">
                                        ...
                                        <div class="deli_info_sub_txt deli_info_main_sub_font mono_sub_color">
                                            <input type="text" name="name" data-placeholder="010-1234-5678" id="place_input5" />
                                        </div>
                                        <%-- <div class="block-example select_style">          
                                            <select class="drkid-select lower-font" style="width:200px;" data-font-class="lower-font">
                                                <option>직접 입력</option>                                             
                                        ...
                                        <div class="delivery_info_wrap_wrap">
                                            ...
                                            <div class="info_box first_border bottom_border">
                                                <div class="info_box_menu">
                                                    <span class="main_title">상품 합계 금액</span>
                                                </div>
                                            ...
                                            <div class="info_box bottom_border">
                                                <div class="info_box_menu">
                                                    <span class="main_title">쿠폰 사용</span>
                                                </div>
                                                <div class="info_box_menu_content">
                                                    <div class="info_box_large_content">
                                                        <div class="info_box_large_content_txt">
                                                            <span>-3,600원 할인 적용 중</span>
                                                        </div>
                                                        <div class="button new_cupon_Btn">
                                                            <span>쿠폰 조회</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--마일리지-->
                                            <div class="info_box bottom_border block">
                                                <div class="info_box_menu">
                                                    <span class="main_title">마일리지</span>
                                                </div>
                                                <div class="info_box_menu_content">
                                                    <div class="info_box_large_content">
                                                        <div class="info_box_large_content_txt">
                                                    ...
                                                    <div class="info_box_large_content_small_txt">
                                                        <span>보유 마일리지 : 1,200원</span>
                                                    </div>
                                                </div>
                                            ...
                                            <!--추천인 코드 이동규-->
                                            <div class="info_box bottom_border" id="Recommander_Space">
                                                <div class="info_box_menu">
                                                    <span>추천인 코드</span>
                                                </div>
                                                <div class="deli_info_sub_txt deli_info_main_sub_font mono_sub_color">
                                                    <input type="text" name="Recommander_Name" />
                                                </div>
                                            </div>
                        ...
                        <div class="delivery_Modal_Input_Area">
                            ...
                            <div class="modal_Input_Area">
                                ...
                                <div class="all_Delivery_Address_Wrap">
                                    ...
                                    <div class="modal_Input_Address">
                                        <input type="text" class="drkid-input lowerst-font" id="I_DELIVERY_ADDRESS_3" name="I_DELIVERY_ADDRESS_3" value="" />
                                    </div>
                                </div>
