<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_LOGIN_SEARCH_PW1.aspx.cs" Inherits="drKid.C_LOGIN_SEARCH_PW1" %>
...
<style>
    ...
    <script>
        $(document).ready(function () {
            ...
            if (cp_ret_status == "N") {
                if (sendflag == "Y") {
                    location.href = "/Source/client/member/login/C_LOGIN_SEARCH_PW2.aspx?way=" + way, "비밀번호찾기";
                }
                if (sendflag == "N") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="real_wrap">
        <div id="wrap">
            ...
            <div id="infotext1">
                <p id="infotext_content1" class="login_info_font">아이디 입력</p>
            </div>
            <div id="textbox">
            ...
            <div id="find_wrap">
                <div id="find">
                    ...
                    <div>
                        ...
                        <a class="lowerst-font" href="/Source/client/member/C_MEMBER_JOINSUPPORT.aspx">회원가입</a>
                    </div>
                </div>
            </div>
        </div>
