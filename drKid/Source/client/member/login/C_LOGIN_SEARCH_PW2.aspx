<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_LOGIN_SEARCH_PW2.aspx.cs" Inherits="drKid.C_LOGIN_SEARCH_PW2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(function () {
            ...
            if (code_flag=="Y") {
                location.href = "/Source/client/member/login/C_LOGIN_SEARCH_PW3.aspx?way=" + way;
            }
        });
