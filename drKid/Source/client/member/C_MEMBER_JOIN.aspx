<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_MEMBER_JOIN.aspx.cs" Inherits="drKid.C_MEMBER_JOIN" %>
    ...
    <script>
        ...
        $(function(){
            ...
            if (cp_ret_status == "Y") {
                ...
                location.href = "/Source/client/member/C_MEMBER_JOINSUCCESS.aspx?username=" + join_user_name;
            } else {
        ...
        function initLayerPosition() {
            var width = 580; //우편번호 서비스가 들어갈 element의 width
                 ...
                 <div class="join_Input_Box">
                    <div class="join_Title_Area">
                     ...
                     <div class="join_Step_Area">
                            <div class="join_Step">
                                <div class="disabled_Txt big-font">약관동의</div>
                                <div class="active_Step_Text big-font">></div>
                                <div class="active_Txt big-font">정보입력</div>
                             ...
                             <div class="join_Input_Data">
                                 <div class="join_Input_Email_Area">
                                     <div class="join_Input_Email_1">
                                         <input type="text" class="drkid-input lowerst-font" id="I_EMAIL" name="I_EMAIL" value="" placeholder="" />
...
<%--                                     <input type="hidden" id="H_ADDRESS"  name="H_ADDRESS" value="FALSE" />--%>
                                     <div class="address_Search_Btn lowerst-font"id="address_Search_Btn" onclick="execDaumPostCode();">우편번호검색
