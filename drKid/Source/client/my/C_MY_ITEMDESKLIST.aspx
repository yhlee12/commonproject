<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_MY_ITEMDESKLIST.aspx.cs" Inherits="drKid.Source.client.my.C_MY_ITEMDESKLIST" %>
     ...
     <script>
         ...
         $(document).ready(function () {
             ...
             $(".hd_List_Row").click(function () {
                 location.href = "/Source/client/my/C_MY_ITEMDESKDETAIL.aspx";
             });
                        ...
                        <div class="Bottom_Area">
                            ...
                            <div class="order_Search_Ui_Area">
                                ...
                                <div class="order_Search_Ui_Title_Area">
                                    <div class="progress_Order_Title KeyDni_Top_Title">나의 상품 문의</div>
                                </div>
                            ...
                            <div class="hd_Area">
                                <div class="hd_List_Title_Area">
                                    <div class="helf_Desk_Request_Btn lowerst-font">상품문의하기</div>
                                </div>
                                <%--리스트--%>
                                <div class="hd_Wrap">
                                            ...
                                            <div class="hd_List_Filed">
                                                ...
                                                <div class="hd_List_Row_Area">
                                                    <div class="hd_List_Row"id="20230612123456789">
                                                        ...
                                                        <div class="hd_List_Row_5_Area">
                                                            <div class="lowerst-font hd_List_Row_4 user_id">abcf1234</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <%-- 있을때 개별 레코드 답변완료--%>
                                                <div class="hd_List_Row_Area">
                                                    <div class="hd_List_Row"id="20230612123456790">
                                                        ...
                                                        <div class="hd_List_Row_5_Area">
                                                            <div class="lowerst-font hd_List_Row_4 user_id">abcf1231234</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <%-- 있을때 개별 레코드 접수--%>
