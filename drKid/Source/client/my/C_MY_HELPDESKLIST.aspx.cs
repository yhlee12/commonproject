...
{
    public partial class C_MY_HELPDESKLIST : PageBase
    {
        public string del_flag = "";
        public string flag = "";
        public string search_btn_click_flag = "";
        public string format_data_value = "";
        ...
        private void set_param()
        {
            ...
            format_data_value = Request.Form["format_data_value"];
        }
        private void search_cs_list()
        {
            ...
            {
                hs.Clear();
                hs.Add("SP_NAME", "PKG_BOARD_MASTER.PBM_MY_CS_LIST");
                ...
                hs.Add("I_BOARD_WRITE_NM", baseUser.userId); // 자기자신의 문의만 볼수있음.
                ...
                hs.Add("I_REQUEST_PROGRAM_ID", "C_HELPDESK_LIST");
