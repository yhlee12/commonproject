...
namespace drKid.Source.client.payment
{
    ...
    public partial class BillApp : System.Web.UI.Page
    {
        //public string key = "rKnPljRn5m6J9Mzz";
        public string key = "q5JAFscOh3P88ktK";
        ...
        public string clientIp = "211.43.207.2"; //가맹점 요청 서버IP (추후 거래 확인 등에 사용됨)
        //public string mid = "INIBillTst";
        public string mid = "oneinterna";
