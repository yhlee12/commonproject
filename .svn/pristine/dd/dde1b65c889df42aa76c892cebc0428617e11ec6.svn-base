<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_MY_REFUNDPRODUCT.aspx.cs" Inherits="drKid.Source.client.my.C_MY_REFUNDPRODUCT" %>
                            ...
                            <div class="KeyDni_Area">
                                ...
                                <div class="KeyDni_Box">
                                    ...
                                    <div class="KeyDni_Info_Area">
                                        ...
                                        <div class="KeyDni_Info_Clicked lower-font" id="C_MY_REFUNDPRODUCT">환불/입금 조회</div>
                        ...
                        <div class="Bottom_Area">
                            ...
                            <div class="order_Search_Ui_Area">
                                ...
                                <div class="order_Search_Ui_Title_Area">
                                    <div class="progress_Order_Title KeyDni_Top_Title">환불/입금 내역</div>
                                </div>
