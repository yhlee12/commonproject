                ...
                <div class="main_Box">
                    ...
                    <div class="detail_Info_Area">
                        ...
                        <div class="detail_Info_Title_Area">
                            ...
                            <div class="detail_Info_Title lower-font"><%=MAGAZINE_LIST.Rows[0]["BOARD_TITLE"]%></div>
                        </div>
                        <%--디테일 작성일 --%>
                        <div class="detail_Info_Period_Area">
                            <div class="detail_Info_Period lowerst-font"><%=((DateTime)MAGAZINE_LIST.Rows[0]["POST_TIME"]).ToString("yyyy.MM.dd")%></div>
                        </div>
                        <%--디테일 이미지+글 영역 --%>
                                            ...
                                            <a href="/Source/client/member/C_PRODUCT_DETAIL.aspx">
                                                <div class="content_wrap custom_content_wrap" id="<%=RECO_PROD_LIST.Rows[j]["PRODUCT_SID"]%>">
                                                    ...
                                                    <%if (!string.IsNullOrEmpty(Convert.ToString(RECO_PROD_EDMS.Rows[j]["TARGET_READ_PATH"])))
                                                      { %>
                                                    <img class='image_for_class2' src='<%=ConfigurationManager.AppSettings["EDMS_VIEW"] %><%=RECO_PROD_EDMS.Rows[j]["TARGET_READ_PATH"] %>' />
                                                    <%}%>
                                                    <%else
                                                      {%>
