<%@ Page Title="" Language="C#" MasterPageFile="~/Source/m/master/drkid_m.Master" AutoEventWireup="true" CodeBehind="M_M_JOINGUIDE.aspx.cs" Inherits="drKid.Source.m.member.M_M_JOINGUIDE" %>
        ...
        $(document).ready(function () {
            ...
            $('.next_Btn').click(function () {
                ...
                if (allChecked) {
                    ...
                    location.href = "/Source/m/member/M_M_JOIN.aspx?LOGIN_TYPE=" + LOGIN_TYPE + "&SOCIAL_ID=" + SOCIAL_ID + "&access_token=" + access_token + "&state=708ff621-f814-4d48-8dd3-6ef9ba462e04&token_type=bearer&expires_in=3600";
                }
                else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="join_Guide_Box">
        ...
        <div class="join_Step_Area">
                <div class="join_Step">
                    <div class="active_Txt m_middle_font">약관동의</div>
                    <div class="active_Step_Text m_middle_font">></div>
                    <div class="disabled_Txt m_middle_font">정보입력</div>
        ...
        <div class="join_Terms_Area">
            <div class="join_Terms_Title_Area">
                <div class="checkbox_Area">
                    ...
                    <label class="drkid-checkbox">
                        ...
                        <span class="join_Terms_Title m_sub_font">약관 전체 동의</span>
                    </label>
                </div>
            </div>
        </div>
            <div class="join_Terms_Sub_Title m_middle_font">회원가입을 위해 이용약관 및 정보이용 안내에 대한 동의가 필요합니다.</div>
            <%--이용약관--%>
            ...
            <%--본인인증--%>
            <div class="auth_Area">
                <div class="auth_Title m_sub_font">본인 인증</div>
