<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_POPUP_MAIN.aspx.cs" Inherits="drKidAdmin.Source.admin.banner.A_POPUP_MAIN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function seq_optimization() {
            ...
            // ^=  는 속성선택자로  pc_img_wrap_로 시작하는 id를 가진요소 모두 each 해당
            ...
            $('.banner_Save_Btn').on('click', function () {
                ...
                for (var i = 0; i < pc_element_count; i++) {
                    ...
                    if(childElementCount <= 1){
                        if ($("input[name='I_VISIBLE_FLAG']:checked").val() === "Y") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sub-warp">
        ...
        <div class="sub-content-wrap">
            <div class="guide_txt lowerst-font mono_sub_color">- 순서대로 팝업이 적용됩니다.</div>
            <div class="guide_txt lowerst-font mono_sub_color">- 팝업은 최대 5개까지 등록이 가능합니다.</div>
            <%if (mainTable.Rows.Count > 0)
            {%>
                <div class="radio_Record_Area">
                    ...
                    <div class="radio_Record">
                        <label class="drkid-radio">
                            <input type="radio" name="I_VISIBLE_FLAG" value="Y" <%=I_VISIBLE_FLAG == "Y" ? "checked=\"checked\"" : "" %> />
                            <span class="radio-txt lowerst-font">노출</span>
                        </label>
                        <label class="drkid-radio">
                            <input type="radio" name="I_VISIBLE_FLAG" value="N"  <%=I_VISIBLE_FLAG == "N" ? "checked=\"checked\"" : "" %>/>
            ...
            {%>
                <div>
                    <label class="drkid-radio">
                        <input type="radio" name="I_VISIBLE_FLAG" value="Y" checked="checked" />
                        <span class="radio-txt lowerst-font">노출</span>
                    </label>
                    <label class="drkid-radio">
                        <input type="radio" name="I_VISIBLE_FLAG" value="N"  />
                        <span class="radio-txt lowerst-font">비노출</span>
                    </label>
                </div>
            <%}%>
                                ...
                                {%>  
                                    ...
                                    { %>
                                        ...
                                        <input type="hidden" name="BANNER_TYPE" value="<%=bannerTable.Rows[j]["BANNER_TYPE"]%>" />
                                            ...
                                            <div class="img_wrap_200 img_wrap"id="pc_img_wrap_<%=i%>" style="width: 392px; height: 214px;">
                                     ...
                                     <%}%>
                                            <div class="column_2_Area_1_txt2">
                                                <div class="lowerst-font mono_dea_color">권장 사이즈 (<span class="lowerst-font drkid_Negative_color">가로 670,세로 365 px</span>)오차범위 200</div>
                                    ...
                                    { %>  
                                        ...
                                        <input type="hidden" name="BANNER_TYPE" value="<%=bannerTable.Rows[z]["BANNER_TYPE"]%>" />
                                            ...
                                            <div class="img_wrap_200 img_wrap"id="mobile_img_wrap_<%=i%>" style="width: 376px; height: 279px;">
                                        ...
                                        <%}%>  
                                            <div class="column_2_Area_1_txt2">
                                                <div class="lowerst-font mono_dea_color">권장 사이즈 (<span class="lowerst-font drkid_Negative_color">가로 700,세로 517 px</span>)오차범위 200</div>
                                                <div class="lowerst-font mono_dea_color">파일용량 (<span class="lowerst-font drkid_Negative_color">2,000KB 초과불가</span></div>
                                                <div class="lowerst-font mono_dea_color">확장자 jpg,png 가능</div>
                                            </div>
                                            <div class="column_2_Area_1_txt3">
                    ...
                    <div class="column_2_Area">
                        <div class="column_pc_mobile_area">
                            ...
                            <input type="hidden" name="BANNER_TYPE" value="WEB" />
                                <div class="column_2_Area_1_txt1">PC</div>
                                <div class="img_wrap_200 img_wrap"id="pc_img_wrap_0" style="width: 392px; height: 214px;">
                                    <img src="/Source/image/no_img.svg" class="no_img" id="pc_no_img_1"/>
                                </div>
                                <div class="column_2_Area_1_txt2">
                                    <div class="lowerst-font mono_dea_color">권장 사이즈 (<span class="lowerst-font drkid_Negative_color">가로 670,세로 365 px</span>)오차범위 200</div>
                            ...
                            <input type="hidden" name="BANNER_TYPE" value="MOBILE" />
                                 <div class="column_2_Area_1_txt1">모바일</div>
                                <div class="img_wrap_200 img_wrap"id="mobile_img_wrap_0" style="width: 376px; height: 279px;">
                                    <img src="/Source/image/no_img.svg" class="no_img" id="mobile_no_img_1" />
                                </div>
                                <div class="column_2_Area_1_txt2">
                                    <div class="lowerst-font mono_dea_color">권장 사이즈 (<span class="lowerst-font drkid_Negative_color">가로 700,세로 517 px</span>)오차범위 200</div>
            ...
            <div class="banner_Add_Btn_Area">
                <div class="banner_Add_Btn middle-font main_color">+ 팝업 추가하기</div>
            </div>
        </div>
        <%--적용하기 버튼--%>
        ...
        <input type="hidden" name="MAIN_SEQ" value="{SEQ}"/>
            ...
            <div class="column_2_Area">
                <div class="column_pc_mobile_area">
                    ...
                    <input type="hidden" name="BANNER_TYPE" value="WEB" />
                        <div class="column_2_Area_1_txt1">PC</div>
                        <div class="img_wrap_200 img_wrap"id="pc_img_wrap_{BSEQ}" style="width: 392px; height: 214px;">
                    ...
                    <input type="hidden" name="BANNER_TYPE" value="MOBILE" />
                        <div class="column_2_Area_1_txt1">모바일</div>
                        <div class="img_wrap_200 img_wrap"id="mobile_img_wrap_{BSEQ}" style="width: 376px; height: 279px;">
