<%@ Page Title="" Language="C#" MasterPageFile="~/Source/m/master/drkid_m.Master" AutoEventWireup="true" CodeBehind="M_L_SEARCH_ID1.aspx.cs" Inherits="drKid.Source.m.member.login.M_L_SEARCH_ID1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            if (cp_ret_status == "N") {
                if (sendflag == "Y") {
                    location.href = "/Source/m/member/login/M_L_SEARCH_ID2.aspx?way=" + way, "아이디찾기";
                }
                if (sendflag == "N") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="real_wrap">
        <div id="wrap">
            ...
            <div id="infotext">
                <p id="infotext_content" class="login_info_font m_sub_font">정보입력</p>
            </div>
            <div>
                <div id="radio_wrap">
            ...
            <div id="find_wrap">
                <div id="find">
                    ...
                    <div>
                        ...
                        <a class="lowerst-font" href="/Source/m/member/M_M_JOINSUPPORT.aspx">회원가입</a>
                    </div>
                </div>
            </div>
        </div>
