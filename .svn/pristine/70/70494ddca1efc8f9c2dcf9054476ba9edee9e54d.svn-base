<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INIbillReturn.aspx.cs" Inherits="INIbillReturn" %>
            ...
            <div class="card">
                ...
                <div class="card_desc">
                    ...
                    <ul>
                        ...
                        <li>가상계좌 채번 후 입금할 경우 자동환불되지 않사오니, 가맹점관리자 내 "입금통보테스트" 메뉴를 이용부탁드립니다.<br>
                ...
                <!-- //유의사항 -->
                <button onclick="location.href='INIbill_pc_req.asp'" class="btn_solid_pri col-6 mx-auto btn_lg" style="margin-top: 50px">돌아가기</button>
