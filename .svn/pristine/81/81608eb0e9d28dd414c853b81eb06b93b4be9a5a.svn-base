<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_SALE_EXCHANGE.aspx.cs" Inherits="drKidAdmin.Source.admin.sale.A_SALE_EXCHANGE__" %>
                            ...
                            <div class="contentArea padding-bottom">
                                ...
                                <div class="content1_button_select">
                                    <select class="drkid-select lowerst-font" data-font-class="lower-font">
                                        ...
                                        <option value="">교환재배송</option>
                                        <option value="">교환거부</option>
                        ...
                        <div class="content2_button">
                            <div class="content2_button_wrap">
                                <div class="content2_button_wrap_inner">
                                    <div class="front_button_wrap">
                                        <div class="front_button">
                                            <%--<div class="drkid-btn-sub">
                                                <span class="lowerst-font">선택 삭제</span>
                                            </div>--%>
                                            <div class="drkid-divider">
                                                <span class="lowerst-font">택배수거</span>
                                            </div>
                                            <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">수거진행</span>
                                            </div>
                                             <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">수거완료</span>
                                            </div>
                                        </div>
                                        <div class="front_button">
                                            <%--<div class="drkid-btn-sub">
                                            ...
                                            <div class="drkid-divider">
                                                <span class="lowerst-font">교환</span>
                                            </div>
                                            <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">교환완료</span>
                                            </div>
                                             <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">교환거부</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <table class="table-common">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="lowerst-font">교환요청일</th>
