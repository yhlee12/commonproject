...
{
    public partial class find_PW : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (find_flag == "phone")
                {
                    ADMIN_NAME = Request.Form["ADMIN_NAME2"];
                    way = "전화번호";
                    find_PW_check();
                    SendMail();
                }
                Session["check_code"] = randomString;
                Session["new_pw"] = randomPW;
        ...
        private void find_PW_check()
        {
            ...
            try
            {
                ...
                if (cp_ret_status == "N")
                {
                    USER_SID = ds.Tables["O_RESULT_CURSOR"].Rows[0]["USER_SID"].ToString();
                }
                else
                {
        ...
        private void SendMail()
        {
            ...
            randomPW = new string(Enumerable.Repeat(lowerchars, 6) // 6자리 랜덤 문자열 생성
                        ...
                        <div style='border:1px solid #bdbdbd; padding:20px 50px 15px 50px; max-width:750px;'>
                          <div>
                            <div style='font-size:30px; margin-top:20px; display:flex; flex-direction:column; align-items:center; '>
                              <div><span style='font-family:Noto Sans Korean;font-weight:500'>PW 찾기 인증번호입니다</span></div>
