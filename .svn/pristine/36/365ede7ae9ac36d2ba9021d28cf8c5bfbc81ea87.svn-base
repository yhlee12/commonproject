<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_LOGIN_SEARCH_ID2.aspx.cs" Inherits="drKid.C_LOGIN_SEARCH_ID2" %>
        ...
        $(function () {
            ...
            $(".send_Btn").on("click", function () {
                ...
                if (sesstionCode == inputCode) {//nOTLuT
                    location.href = "/Source/client/member/login/C_LOGIN_SEARCH_ID3.aspx";
                }
                else {
