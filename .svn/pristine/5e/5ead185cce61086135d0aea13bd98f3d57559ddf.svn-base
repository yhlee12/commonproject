        ...
        $(document).ready(function () {
            ...
            $('.next_Btn').click(function () {
                ...
                if (allChecked) {
                    ...
                    location.href = "/Source/client/member/C_MEMBER_JOIN.aspx?LOGIN_TYPE=" + LOGIN_TYPE + "&SOCIAL_ID=" + SOCIAL_ID + "&access_token=" + access_token + "&state=708ff621-f814-4d48-8dd3-6ef9ba462e04&token_type=bearer&expires_in=3600";
                }
                else {
