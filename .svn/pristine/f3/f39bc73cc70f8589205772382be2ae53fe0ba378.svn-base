<%@ Page Title="" Language="C#" MasterPageFile="~/Source/m/master/drkid_m.Master" AutoEventWireup="true" CodeBehind="M_L_SEARCH_ID3.aspx.cs" Inherits="drKid.Source.m.member.login.M_L_SEARCH_ID3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="real_wrap">
        <div id="wrap">
            <div id="title_wrap">
                <p class="login_title m_main_font">아이디 찾기</p>
            </div>
            <div id="infotext">
                <p id="infotext_content" class="m_sub_font">아이디 찾기 완료</p>
            </div>
            <div>
                <div id="codecontent">
            ...
            <div>
                <div id="loginbutton">
                    <button class="login_button_font findEnterkey" type="button" onclick="location.href='/Source/m/member/login/M_L_SEARCH_PW1.aspx'">비밀번호 찾기 </button>
                </div>
            </div>
            <div id="find_wrap">
                <div id="find">
