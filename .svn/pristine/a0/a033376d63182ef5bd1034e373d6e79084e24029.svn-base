<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_SELOVE_BANNER.aspx.cs" Inherits="drKidAdmin.Source.admin.selove.A_SELOVE_BANNER" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sub-warp">
        ...
        <div class="sub-content-wrap">
            ...
            <div class="guide_txt lowerst-font mono_sub_color">- 셀럽샵 배너는 <%=limit%>장까지 등록가능합니다.</div>
