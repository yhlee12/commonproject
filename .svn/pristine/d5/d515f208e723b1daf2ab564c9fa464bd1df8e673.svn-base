...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">   
    ...
    <script>
        $(function () {
            ...
            if (cp_ret_status == "Y") {
                ...
                if (redirect_flag == "product") {
                    location.href = "/Source/client/member/C_C_PRODUCT_PURCHASE.aspx";
                }
                if (redirect_flag == "coupon") {
    ...
    <script>
        ...
        $(document).ready(function () {
            naver_id_login = new naver_id_login("K1garAbjL0UqgAPq_hx4", "http://211.43.207.2/Source/client/member/login/C_LOGIN_Page.aspx"); //클라인언트ID , 콜백 URL
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="wrap">
        ...
        <div  id="find_wrap">
            <div  id="find">
                <div>
                    <a class="lowerst-font" href="/Source/client/member/login/C_LOGIN_SEARCH_ID1.aspx">아이디 찾기</a>
                    <span id = "a1">  |   </span>
                    <a class="lowerst-font" href="/Source/client/member/login/C_LOGIN_SEARCH_PW1.aspx">비밀번호 찾기</a>
                </div>
                <div></div>
                <div>
                    <a class="joinbtn lowerst-font" href="#">회원가입</a>
                </div>
            </div>
        </div>      
        <div id = "line_wrap">
        ...
        <div id = "naverlogo"> 
            <div class="button" >
                <div  class ="logocontentflex">
                    ...
                    <div  class = "space login_logo_font lower-font">네이버 간편 로그인</div>
