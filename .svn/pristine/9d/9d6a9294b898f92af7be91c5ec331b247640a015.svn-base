...
namespace drKid.Source.m
{
    ...
    public partial class m_main : PageBase
    {
        ...
        private void setMainData()
        {
            ...
            try
            {
                ...
                hs.Add("I_REQUEST_PROGRAM_ID", "M_MAIN");
                ...
                if (cp_ret_status == "N")
                {
                    ...
                    {
                        settingViewMain(ds.Tables["O_RESULT_CURSOR_IMAGE"], "MOBILE");
                    }
        ...
        private void settingViewMain(DataTable dt, string Type = "MOBILE")
        {
        ...
        protected void Logout_to_Server_ServerClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/Source/m/member/login/M_L_LOGIN_Page.aspx");
        }
