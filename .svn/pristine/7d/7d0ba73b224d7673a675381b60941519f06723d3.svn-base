<%@ Page Title="" Language="C#" MasterPageFile="~/Source/m/master/drkid_m.Master" AutoEventWireup="true" CodeBehind="M_M_INQUERY_WRITE.aspx.cs" Inherits="drKid.Source.m.my.M_M_INQUERY_WRITE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".request_Cansle_Btn").on("click", function () {
