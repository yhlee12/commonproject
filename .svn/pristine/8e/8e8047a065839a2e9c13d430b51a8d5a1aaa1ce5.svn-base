<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_CUPOINT_MAGAZINE_LIST.aspx.cs" Inherits="drKidAdmin.Source.admin.cupoint.A_CUPOINT_MAGAZINE_LIST" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        var I_FAQ_TYPE = "<%=I_FAQ_TYPE%>"
        var $matches = `<%=matches%>`;
        $(function () {
            //매거진 등록
            $("#create-Magazine").click(function () {
                openMenuPath("/Source/admin/cupoint/A_CUPOINT_MAGAZINE_EDIT.aspx", "", true);
            });
            ...
            $(".edit_Btn").click(function () {
                ...
                openMenuPath("/Source/admin/cupoint/A_CUPOINT_MAGAZINE_EDIT.aspx", queryString, true);
            });
            ...
            //카테고리 라디오 값 
            if (I_FAQ_TYPE != null || I_FAQ_TYPE != "") {
                //검색했던 라디오 버튼을 form submit 뒤에도 초기화 방지
                $('input:radio[name=category_type]').filter(function () {
                    return $(this).val() === I_FAQ_TYPE;
                }).prop('checked', true);
            }
                         ...
                         <div class="category_wrap">
                             ...
                             <div class="category">
                                <label class="drkid-radio">
                                    ...
                                    <span class="radio-txt lowerst-font">PRODUCT</span>
                                </label>
                             </div>

                             <div class="category">
                                    <label class="drkid-radio">
                                        <input type="radio" name="category_type" value="ISSUE" />
                                        <span class="radio-txt lowerst-font">ISSUE</span>
                                    </label>
                                 </div>
        ...
        <div class="sub-content-wrap">
            <div class="btn-field clears btn-field-custom ">
                ...
                <div class="flex-right-child grid-chid">
                    ...
                    <div class="drkid-btn search-btn drkid-btn-active" id="create-Magazine">
                        <span class="lowerst-font">매거진 등록</span>
                    </div>
                </div>
            </div>
                         ...
                         <% if (MAGAZINE_LIST != null)
                             { %>
                                 <%for (int i = 0; i < MAGAZINE_LIST.Rows.Count; i++)
                                  { %>
                                     <tr data-sub-tr="<%=i%>">
                                        <td class="lower-font"data-value="<%=MAGAZINE_LIST.Rows[i]["BOARD_SID"] %>">
                                        ...
                                        <td class="lower-font">
                                            <div class="drkid-btn-active edit_Btn"id="<%=MAGAZINE_LIST.Rows[i]["BOARD_SID"] %>">수정</div>
                                        </td>
                                        <td class="lower-font">
                                        ...
                                        <td class="lower-font">
                                            <div class="lowerst-font"><%=MAGAZINE_LIST.Rows[i]["FAQ_TYPE"]%></div>
                                        </td>
                                        <td class="list_Title_Area lower-font">
                                            <div class="list_Title lowerst-font"><%=MAGAZINE_LIST.Rows[i]["BOARD_TITLE"] %></div>
                                        </td>

                                        <td class="lower-font">
                                            <div class="list_Title lowerst-font list_Title_Custom"><%=((DateTime)MAGAZINE_LIST.Rows[i]["POST_TIME"]).ToString("yyyy.MM.dd") %></div>
                                        </td>
