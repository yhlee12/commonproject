    ...
    <script>
        $(function () {
            ...
            $("#user_enter_btn").on("click", function () {
                ...
                console.log(pass);
                if (m_input == pass) {
                    location.href = "/Source/m/cs/M_CS_HELPDESKDETAIL.aspx?bsid=" + bsid;
                }
                else {
                    $(".pass_guide").show();
                    $(".no_pass").show();
        ...
        <div class="helpDeskList_wrap">
            ...
            <div class="add_button">
                <div class="add_button_wrap">
                    <div class="add_button_wrap_button main_bg_color" id="request_edit_btn">
                ...
                <div id="modal" class="modal">
                    <div class="modal-content">
                        ...
                        <div id="pop-modal-wraper">
                            <div class="modal_txt m_middle_font">
                                <span>문의글 확인을 위해 비밀번호를 입력해주세요.</span>
                            </div>
                        ...
                        <div id="pop-modal-btn-wraper">
                            <div class="drkid-btn-sub2 drkid-btn-active admin_save_Btn findEnterkey" id="user_enter_btn">
                                <span class="m_middle_font modal-btn-font">확인</span>
                            </div>
                            <div class="drkid-btn-sub2 closeBtn">
                                <span class="m_middle_font modal-btn-font">취소</span>
                            </div>
                        </div>
                    </div>
                </div>
