<%@ Page Title="" Language="C#" MasterPageFile="~/Source/client/master/DRKID.Master" AutoEventWireup="true" CodeBehind="C_MY_CUPONLIST.aspx.cs" Inherits="drKid.Source.client.my.C_MY_CUPONLIST" %>
                        ...
                        <div class="Bottom_Area">
                            ...
                            <div class="progress_Order_Area">
                                <div class="progress_Order_Title_Area">
                                    <div class="progress_Order_Title KeyDni_Top_Title">MY 쿠폰</div>
                                </div>
                                <%--MY 쿠폰 전체 영역--%>
                                <div class="my_Cupon_Area">
                                    ...
                                    <div class="my_CuponTop_Area">
                                        <div class="my_CuponTop">
                                            <div class="sub_My_CuponTop">
                                                <div class="lower-font font_weight_500 cupon_InfoTxt">쿠폰 코드 등록</div>
                                                <div class="input_Wrap">
                                                    <input type="text" name="I_CUPON_NUM" class="drkid-input lowerst-font" value="" placeholder="쿠폰 코드 번호 입력" />
                                                </div>
                                                <div class="cupon_Register_Btn_Area">
                                                    <div class="cupon_Register_Btn lowerst-font">등록</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="searchUi_Area">
                                        <div class="searchUi_Content clicked lowerst-font All_coupon_view">전체</div>
                                        <div class="searchUi_Content lowerst-font Available_coupon_view">사용가능</div>
                                        <div class="searchUi_Content lowerst-font Unavailable_coupon_view">사용불가</div>
                                    </div>
