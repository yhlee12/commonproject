...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            //카테고리 라디오 버튼 선택 시 sp에 값을 넘겨주기 위해 세팅
            $('input[name="category_type"]').change(function () {
                ...
                $("#I_IMPORTANCE_FLAG").val(selectedValue);
            ...
            //검색하고 난 뒤 카테고리 값 초기화 방지
            var I_IMPORTANCE_FLAG = "<%=I_IMPORTANCE_FLAG %>";
            if (I_IMPORTANCE_FLAG.length > 0 ) {
                console.log("I_IMPORTANCE_FLAG : ", I_IMPORTANCE_FLAG);
                $("#I_IMPORTANCE_FLAG").val(I_IMPORTANCE_FLAG);
                console.log($("#I_IMPORTANCE_FLAG").val())
                //검색했던 라디오 버튼을 form submit 뒤에도 초기화 방지
                $('input:radio[name=category_type]').filter(function () {
                    return $(this).val() === I_IMPORTANCE_FLAG;
                }).prop('checked', true);
            }
            ...
            $(".edit_Btn").click(function () {
                ...
                openMenuPath("/Source/admin/cs/A_CS_BOARDEDIT.aspx", queryString, true);
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="hidden-field">
          ...
          <input type="text" name="I_IMPORTANCE_FLAG" id="I_IMPORTANCE_FLAG" value="*" />
                 ...
                 <div class="sub-content-select-ui">
                     ...
                     <div class="category-area">
                         ...
                         <div class="category_wrap">
                             ...
                             <div class="category">
                                    <label class="drkid-radio">
                                        <input type="radio" name="category_type" value="Y" />
                             ...
                             { %>
                                 <%for (int i = 0; i < NOTICE_LIST.Rows.Count; i++)
                                  { %>
                                    ...
                                    <tr data-sub-tr="<%=i%>">
                                        <td class="lower-font"data-value="<%=NOTICE_LIST.Rows[i]["BOARD_SID"] %>">
                                        ...
                                        <td class="lower-font">
                                            <div class="drkid-btn-active edit_Btn"id="<%=NOTICE_LIST.Rows[i]["BOARD_SID"] %>">수정</div>
                                        </td>
                                        <td class="lower-font">
                                        ...
                                        <td class="lower-font">
<%--                                            <div class="lowerst-font"><%=NOTICE_LIST.Rows[i]["IMPORTANCE_FLAG"] %></div>--%>
                                        ...
                                        <td class="list_Title_Area lower-font">
                                            <div class="list_Title lowerst-font"><%=NOTICE_LIST.Rows[i]["BOARD_TITLE"] %></div>
                                        </td>
