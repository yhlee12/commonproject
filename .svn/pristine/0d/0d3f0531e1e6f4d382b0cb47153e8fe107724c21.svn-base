<%@ Page Title="" Language="C#" MasterPageFile="~/Source/m/master/drkid_m.Master" AutoEventWireup="true" CodeBehind="M_M_PRODUCT_DETAIL_PURCHASE.aspx.cs" Inherits="drKid.Source.m.my.M_M_PRODUCT_DETAIL_PURCHASE" %>
        ...
        $(document).ready(function () {
            ...
            $("#go_paymnet").on("click", function () {
                ...
                if (payment_flag =="common") {
                    ...
                    objs12.setAttribute('type', 'text');
                    objs12.setAttribute('name', 'P_NOTI');
                    objs12.setAttribute('value', "noti_test");
                ...
                if (payment_flag == "bill") {
                    ...
                    var objs1 = document.createElement('input'); // 값이 들어있는 녀석의 형식
                    objs1.setAttribute('type', 'text'); // 값이 들어있는 녀석의 type
                    objs1.setAttribute('name', 'authtype'); // 객체이름
                    objs1.setAttribute('value', "D"); //객체값

                    var objs2 = document.createElement('input');
                    objs2.setAttribute('type', 'text');
                    objs2.setAttribute('name', 'mid');
                    objs2.setAttribute('value', "INIBillTst");

                    var objs3 = document.createElement('input');
                    objs3.setAttribute('type', 'text');
                    objs3.setAttribute('name', 'orderid');
                    objs3.setAttribute('value', "<%=orderid%>");

                    var objs4 = document.createElement('input');
                    objs4.setAttribute('type', 'text');
                    objs4.setAttribute('name', 'price');
                    objs4.setAttribute('value', "1000");

                    var objs5 = document.createElement('input');
                    objs5.setAttribute('type', 'text');
                    objs5.setAttribute('name', 'timestamp');
                    objs5.setAttribute('value', "<%=timestamp%>");

                    var objs6 = document.createElement('input');
                    objs6.setAttribute('type', 'text');
                    objs6.setAttribute('name', 'hashdata');
                    objs6.setAttribute('value', "<%=hashdata%>");

                    var objs7 = document.createElement('input');
                    objs7.setAttribute('type', 'text');
                    objs7.setAttribute('name', 'period');
                    objs7.setAttribute('value', "M2");

                    var objs8 = document.createElement('input');
                    objs8.setAttribute('type', 'text');
                    objs8.setAttribute('name', 'goodname');
                    objs8.setAttribute('value', "테스트상품");

                    var objs9 = document.createElement('input');
                    objs9.setAttribute('type', 'text');
                    objs9.setAttribute('name', 'buyername');
                    objs9.setAttribute('value', "테스터");

                    var objs10 = document.createElement('input');
                    objs10.setAttribute('type', 'text');
                    objs10.setAttribute('name', 'buyertel');
                    objs10.setAttribute('value', "01012345678");

                    var objs11 = document.createElement('input');
                    objs11.setAttribute('type', 'text');
                    objs11.setAttribute('name', 'buyeremail');
                    objs11.setAttribute('value', "test@test.com");

                    var objs12 = document.createElement('input');
                    objs12.setAttribute('type', 'text');
                    objs12.setAttribute('name', 'returnurl');
                    objs12.setAttribute('value', "http://localhost:18848/Source/client/payment/mINIbillReturn.aspx");

                    var objs13 = document.createElement('input');
                    objs13.setAttribute('type', 'text');
                    objs13.setAttribute('name', 'carduse');
                    objs13.setAttribute('value', "");

                    var objs14 = document.createElement('input');
                    objs14.setAttribute('type', 'text');
                    objs14.setAttribute('name', 'merchantreserved');
                    objs14.setAttribute('value', "t2ltest merchantreserved");
                    ...
                    form.setAttribute('method', 'post'); //get,post 가능
                    form.setAttribute('target', '_self');
                    var bill_select_code = $("#gopaymethod").val();
                    
                    if (bill_select_code == "Card") {
                        form.setAttribute('action', "https://inilite.inicis.com/inibill/inibill_card.jsp"); //보내는 url
                    }
                    if (bill_select_code == "HPP") {
                        var objs15 = document.createElement('input');
                        objs15.setAttribute('type', 'text');
                        objs15.setAttribute('name', 'type');
                        objs15.setAttribute('value', "2");
                        form.appendChild(objs15);

                        form.setAttribute('action', "https://inilite.inicis.com/inibill/inibill_hpp.jsp"); //보내는 url
                    }
                    document.body.appendChild(form);
                }
                form.submit();
