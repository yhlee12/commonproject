                    ...
                    <table class="table-common">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <%--카테고리--%>
                                <td class="lowerst-font"><%=listTable.Rows[i]["CATEGORY_NAME"].ToString().Replace(",","<br/>") %></td>
                                <%--판매가--%>
                                ...
                                <%--전시상태--%>
                                <td class="lowerst-font"><%=listTable.Rows[i]["VIEW_FLAG"].ToString() == "Y" ? "전시중" : "전시중단"%></td>
                                <%--잔여수량--%>
