                            ...
                            <li class="menu-main-li" data-id="<%=menu.Value.key %>">
                                ...
                                <%if(menu.Value.subMenu != null && menu.Value.subMenu.Count > 0){ %>
                                    ...
                                    <%foreach(var submenu in menu.Value.subMenu){ %>      
                                        <li class="lowerst-font menuOpen <%=submenu.viewFlag == false ? "noShowDiv" : "" %>" data-title="<%=submenu.title %>" data-path="<%=submenu.path %>.aspx" data-query-string="<%=submenu.pageQueryString %>" data-sub-key="<%=submenu.key %>"><%=submenu.title %></li>
                                    <%} %>
                                    </ul>
                                <%} %>
