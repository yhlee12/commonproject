<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_COMM_TODAY.aspx.cs" Inherits="drKidAdmin.Source.admin.community.A_COMM_TODAY" %>
...
<div class="sub-wrap">
    <div class="sub-warp-title custom-sub-warp-title">
        <span class="middle-font custom-sub-warp-txt ">오늘의 커뮤니티 관리</span>
    </div>
</div>
<div class="Main_wrap">
    <div class="table-wraper max-height-overflow custom-table-wraper">
        <table class="table-common">
            ...
            <tbody id="big-tbody">
                ...
                <tr> 
                    <td>
                        <div data-boardsid ="<%=NORMAL_LIST.Rows[i]["BOARD_SID"] %>" class="Today_Detail_BTN" >
                            <span>상세</span>
                        </div>
                    </td>
                    <td><%=totalCount - i %></td>
                    <td><%=NORMAL_LIST.Rows[i]["BOARD_TITLE"] %></td>
                    <td><%=NORMAL_LIST.Rows[i]["CODE_NAME"] %></td>
                    <td><%=NORMAL_LIST.Rows[i]["RECOMMEND_COUNT"] %></td>
                    <td><%=NORMAL_LIST.Rows[i]["POST_USER_NAME"] %></td>
                    <td><%=NORMAL_LIST.Rows[i]["POST_TIME"] %></td>
                    <td>
                        <div class="Today_Delete_BTN" data-boardsid ="<%=NORMAL_LIST.Rows[i]["BOARD_SID"] %>">
                            <span>삭제</span>
                        </div>
                    </td>
                </tr>
