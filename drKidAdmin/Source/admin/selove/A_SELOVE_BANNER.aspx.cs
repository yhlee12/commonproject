...
namespace drKidAdmin.Source.admin.selove
{
    public partial class A_SELOVE_BANNER : PageBase
    {
        public string cp_ret_status = "";
        public string cp_ret_message = "";
        public string save_flag = "";
        string flag = "";
        public Int32 limit = 3;
        //메인
        string[] MAIN_SID;
        string[] MAIN_SEQ;
        string[] I_TITLE;
        ...
        private void saveMainAndBanner()
        {
            ...
            try
            {
                ...
                hs.Add("I_MAIN_TYPE", "SELOVE");

                hs.Add("I_LANGUAGE_CODE", "KOR");
                hs.Add("I_PROGRESS_GUID", BizUtil.getGUID());
                hs.Add("I_REQUEST_USER_ID", baseUser.userId);
                hs.Add("I_REQUEST_IP_ADDRESS", baseUser.userIpAddress);
                hs.Add("I_REQUEST_PROGRAM_ID", "A_SELOVE_BANNER");
                ...
                if (cp_ret_status == "N")
                {
                    ...
                    try
                    {
                        ...
                        _hs.Add("I_REQUEST_PROGRAM_ID", "A_SELOVE_BANNER");
        ...
        {
            var JsonData = UploadUtil.noLimit_UploadForImage(e);
