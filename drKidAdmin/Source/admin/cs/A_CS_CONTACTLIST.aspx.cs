...
namespace drKidAdmin.Source.admin.cs
{
    public partial class A_CS_CONTACTLIST : PageBase
    {
        ...
        private void set_param()
        {
            ...
            if (I_BOARD_USER_TYPE == "USER")
            {
                I_BOARD_WRITE_SID = Request.Form["I_BOARD_WRITE_SID"];
                I_BOARD_WRITE_NM = Request.Form["I_USER_SEARCH_ID"];
            }
            if (I_BOARD_USER_TYPE == "01")
            {
                I_BOARD_WRITE_SID = Request.Form["I_NONMEMBER_SEARCH_POHNE"].Replace("-", "").Replace("-", "");
                I_BOARD_WRITE_NM = Request.Form["I_NONMEMBER_SEARCH_NAME"];
            }
        ...
        private void search_cs_list()
        {
            ...
            try
            {
                ...
                hs.Add("I_BOARD_USER_TYPE", I_BOARD_USER_TYPE);
