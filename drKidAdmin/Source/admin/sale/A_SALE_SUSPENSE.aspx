<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_SALE_SUSPENSE.aspx.cs" Inherits="drKidAdmin.Source.admin.sale.A_SALE_SUSPENSE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="wrap">
        <div class="sub-warp">
            ...
            <%--주문조회 안내 텍스트--%>
            <div class="title_txt">
                <p class="lowerst-font">구매자가 무통장입금 또는 결제/입금이 완료되지 않은 주문 건을 확인하실 수 있습니다.</p>
                <div class="title_txt_span lowerst-font">
                    <span>구매자명(수취인명)의 연락처나 배송지 등 정보는 표시되지 않으며, 입금/결제가 완료되면 [주문관리]메뉴에 신규 주문건으로 표시되어 모든 정보를 확인할 수 있습니다.</span><br />
                    <span>무통장입금으로 결제한 경우 주문일로부터 2영업일 내에 결제 완료되지 않을 경우 주문은 자동으로 취소됩니다.</span>
                </div>
            </div>
           <%--주문조회 조회 조건--%>
            <div class="content">
