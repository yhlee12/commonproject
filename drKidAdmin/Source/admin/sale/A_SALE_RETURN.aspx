<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_SALE_RETURN.aspx.cs" Inherits="drKidAdmin.Source.admin.sale.A_SALE_RETURN" %>
                                ...
                                <div class="content2_button_wrap_inner">
                                    <div class="front_button_wrap">
                                        ...
                                        <div class="front_button">
                                            ...
                                            <div class="drkid-divider">
                                                <span class="lowerst-font">반품</span>
                                            </div>
                                            <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">반품완료</span>
                                            </div>
                                             <div class="drkid-btn-sub2">
                                                <span class="lowerst-font">반품거부</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="drkid-btn-sub2">
                            ...
                            <table class="table-common">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="lowerst-font">반품요청일</th>
