<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_CUPOINT_EVENT_EDIT.aspx.cs" Inherits="drKidAdmin.Source.admin.cupoint.A_CUPOINT_EVENT_EDIT" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $('#cansle_Btn').on('click', function () {
            hideProgress();
            closeTabPath("/Source/admin/cupoint/A_CUPOINT_EVENT_EDIT.aspx");//탭 닫기
        });
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sub-warp">
        ...
        <div class="sub-content-wrap_custom">
            <%if (REQUEST_EVENT_LIST != null)
              {%>
            <%for (int i = 0; i < REQUEST_EVENT_LIST.Rows.Count; i++)
              { %>
            <div class="sub-content-request-ui-area">
                <%--노출 STATUS--%>
                <div class="category_request_area">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">*&nbsp;</span>노출 설정</div>
                    <div>
                        <label class="drkid-radio">
                            <input type="radio" name="I_EVENT_STATUS" value="Y" <%=request_event_status == "Y" ? "checked=\"checked\"" : "" %> />
                            <span class="radio-txt lowerst-font">노출</span>
                        </label>
                        <label class="drkid-radio">
                            <input type="radio" name="I_EVENT_STATUS" value="N" <%=request_event_status == "N" ? "checked=\"checked\"" : "" %> />
                            <span class="radio-txt lowerst-font">비노출</span>
                        </label>
                    </div>
                </div>
                ...
                <%--이벤트 FROM--%>
                <div class="category_request_area">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">*&nbsp;</span>이벤트 시작일</div>
                    <div class="category_select_area">
                        <div class="datePicker lower-font" style="width: 220px;">
                            <input type="text" value="<%= ((DateTime)REQUEST_EVENT_LIST.Rows[i]["EVENT_FROM"]).ToString("yyyy-MM-dd")%>" class="datePicker-input" placeholder="PlaceHolder입니다." data-picker-count="2" id="" name="I_DATE_START" />
                            <div class="datePicker-icon"><span class="material-icons">event_available</span></div>
                        </div>
                    </div>
                </div>
                <%--이벤트 TO--%>
                <div class="category_request_area2">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">*&nbsp;</span>이벤트 종료일</div>
                    <div class="category_select_area">
                        <div class="radio_datePicker">
                            <div>
                                <label class="drkid-radio">
                                    <input type="radio" name="I_FROM_OPTION" value="" <%=request_event_option == "" ? "checked=\"checked\"" : "" %> />
                                    <span class="radio-txt lowerst-font"></span>
                                </label>
                            </div>
                            <div class="datePicker lower-font" style="width: 220px;">
                                ...
                                <%if (request_event_to != "")
                                  {%>
                                <input type="text" value="<%= ((DateTime)REQUEST_EVENT_LIST.Rows[i]["EVENT_TO"]).ToString("yyyy-MM-dd")%>" class="datePicker-input" placeholder="PlaceHolder입니다." data-picker-count="2" id="" name="I_DATE_END" />
                                <%}%>

                                <%else
                                  {%>
                                <input type="text" value="" class="datePicker-input" placeholder="PlaceHolder입니다." data-picker-count="2" id="I_DATE_END" name="I_DATE_END" />
                                <%}%>
                        ...
                        <div>
                            <label class="drkid-radio">
                                <input type="radio" name="I_FROM_OPTION" value="EVENT_END" <%=request_event_option == "EVENT_END" ? "checked=\"checked\"" : "" %> />
                                <span class="radio-txt lowerst-font">이벤트 종료 시</span>
                            </label>
                        </div>
                        <%--쿠폰 매진 시 라디오 버튼--%>
                        <div>
                            <label class="drkid-radio">
                                <input type="radio" name="I_FROM_OPTION" value="COUPON_END" <%=request_event_option == "COUPON_END" ? "checked=\"checked\"" : "" %> />
                                <span class="radio-txt lowerst-font">쿠폰 매진 시</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="common_category_area">
                    ...
                    <div class="lowerst-font mono_dea_color" id=""><%= ((DateTime)REQUEST_EVENT_LIST.Rows[i]["POST_TIME"]).ToString("yyyy.MM.dd")%></div>
                </div>

                <%--PC/MOBILE이미지 등록 영역--%>
                <div class="common_category_area">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">*&nbsp;</span>이벤트 이미지 등록</div>
                    ...
                    <div class="column_2_Area_1">
                        ...
                        <div class="img_wrap_200 img_wrap" id="pc_img_wrap_<%=i%>" style="width: 410px; height: 280px;">
                            ...
                            <input type='hidden' name='image_upload_name' value='<%=REQUEST_EVENT_LIST.Rows[i]["SOURCE_FILE_NAME"] %>' />
                            <input type='hidden' name='image_upload_ext' value='<%=REQUEST_EVENT_LIST.Rows[i]["EXT"] %>' />
                            <input type='hidden' name='image_upload_sid' value='<%=REQUEST_EVENT_LIST.Rows[i]["EDM_SID"] %>' />
                            <img class='image_for_class' src='<%=ConfigurationManager.AppSettings["EDMS_VIEW"] %><%=REQUEST_EVENT_LIST.Rows[i]["TARGET_READ_PATH"] %>' />
                        </div>
                ...
                <div class="common_category_area">
                    ...
                    <textarea class="lower-font" id="I_TITLE" name="I_TITLE" placeholder="제목을 입력해 주세요."><%=REQUEST_EVENT_LIST.Rows[i]["BOARD_TITLE"] %></textarea>
                </div>
                <%--내용 영역--%>
                <div class="common_category_area">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">*&nbsp;</span>내용</div>
                    <div class="sm_wrap">
                        <textarea class="lower-font" name="smarteditor" id="smarteditor" style="width: 100%;" placeholder="내용을 입력해 주세요."><%=REQUEST_EVENT_LIST.Rows[i]["BOARD_MESSAGE"] %></textarea>
                    </div>
                </div>
                <%--이미지 추가--%>
                <div class="common_category_area">
                ...
                <div class="common_category_area2">
                    <div class="category_txt lowerst-font"><span class="drkid_Negative_color lowerst-font">&nbsp;</span>URL 연결</div>
                    <div class="url_Area">
                        <input type="text" class="drkid-input lowerst-font INPUT" name="I_URL" value="<%=REQUEST_EVENT_LIST.Rows[i]["EVENT_URL"] %>" />
                    </div>
                </div>
                <%--상품연결 버튼--%>
                <div class="common_category_area2">
            ...
            <div class="sub-content-request-ui-area">
                ...
                <div class="category_request_area">
                    ...
                    <div>
                        <label class="drkid-radio">
                            <input type="radio" name="I_EVENT_STATUS" value="Y" checked="checked" />
                            <span class="radio-txt lowerst-font">노출</span>
                        </label>
                        <label class="drkid-radio">
                            <input type="radio" name="I_EVENT_STATUS" value="N" />
                            <span class="radio-txt lowerst-font">비노출</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="category_request_area">
                    ...
                    <div class="category_select_area">
                        <div class="datePicker lower-font" style="width: 220px;">
                            <input type="text" value="" class="datePicker-input" placeholder="PlaceHolder입니다." data-picker-count="2" id="I_DATE_START" name="I_DATE_START" />
                            <div class="datePicker-icon"><span class="material-icons">event_available</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="category_request_area2">
                    ...
                    <div class="category_select_area">
                        <div class="radio_datePicker">
                            <div>
                                <label class="drkid-radio">
                                    <input type="radio" name="I_FROM_OPTION" value="" checked="checked" />
                                    <span class="radio-txt lowerst-font"></span>
                                </label>
                            </div>
                            <div class="datePicker lower-font" style="width: 220px;">
                        ...
                        <div>
                            <label class="drkid-radio">
                                <input type="radio" name="I_FROM_OPTION" value="EVENT_END" />
                                <span class="radio-txt lowerst-font">이벤트 종료 시</span>
                            </label>
                        </div>
                        <%--쿠폰 매진 시 라디오 버튼--%>
                        <div>
                            <label class="drkid-radio">
                                <input type="radio" name="I_FROM_OPTION" value="COUPON_END" />
                                <span class="radio-txt lowerst-font">쿠폰 매진 시</span>
                            </label>
                        </div>
                    </div>
