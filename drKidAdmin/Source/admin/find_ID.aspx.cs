                        ...
                        <div style='border:1px solid #bdbdbd; padding:20px 50px 15px 50px; max-width:750px;'>
                          ...
                          <div style='margin-top:30px;'>
                            ...
                            <div style='font-family:Pretendard; font-weight:600; padding: 35px 85px 0px 85px; font-size: 14px;'>
                                <button type=button onclick=window.open('http://www.t2l.co.kr/');  style='border:none; display:flex;justify-content:center; align-items:center; width:100%; height:50px; background-color:#115c5e; color:white; font-family:Noto Sans Korean;font-weight:600; font-size: 14px;'>Dr.KeyDni 관리자 바로가기＞</button>
                            </div>
                          </div>
                        </div>
                      </body>
