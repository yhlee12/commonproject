<%@ Page Title="" Language="C#" MasterPageFile="~/Source/admin/master/Web.master" AutoEventWireup="true" CodeBehind="A_BANNER_MIDDLE.aspx.cs" Inherits="drKidAdmin.Source.admin.banner.A_BANNER_MIDDLE" %>
    ...
    <div class="sub-warp">
        ...
        <div class="sub-content-wrap">
                                ...
                                <div class="title_Area">
                                    ...
                                    <div class="title_Wrap">
                                        ...
                                        <div class="input_Title_Lenght">
                                            <div id="input_Title_Start" class="lowerst-font main_color">0</div>
                                            <span class="lowerst-font" style="color: #D8D8D8;">&nbsp;/&nbsp;</span>
                                ...
                                <div class="subtitle_Area">
                                    ...
                                    <div class="title_Wrap">
                                        ...
                                        <div class="input_Sub_Title_Lenght">
                                            <div id="input_Sub_Title_Start" class="lowerst-font main_color">0</div>
                                            <span class="lowerst-font" style="color: #D8D8D8;">&nbsp;/&nbsp;</span>
            ...
            <div class="banner_Save_Btn_Area">
                <div class="banner_Save_Btn middle-font" data-value="">적용하기</div>
            </div>
        </div>
    </div>
